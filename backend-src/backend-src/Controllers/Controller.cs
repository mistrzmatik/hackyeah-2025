...
namespace backend_src.Controllers
{
    ...
    public class Controller : ControllerBase
    {
        ...
        public ActionResult<PostPrognozujEmerytureResponse> PostPrognozujEmeryture(PostPrognozujEmerytureRequest request)
        {
            ...
            var przewidywaneKonto = kalkulatorEmerytury.PrzewidzWartoscNaKoncie(kwotaNaKoncie, request.WynagrodzeniaBrutto[request.WynagrodzeniaBrutto.Keys.Max()], request.WynagrodzeniaBrutto.Keys.Max(), 2100, request.WskaznikWaloryzacjiKonta);
            var przewidywaneSubkonto = kalkulatorEmerytury.PrzewidzWartoscNaSubkoncie(kwotaNaSubkoncie, request.WynagrodzeniaBrutto[request.WynagrodzeniaBrutto.Keys.Max()], request.WynagrodzeniaBrutto.Keys.Max(), 2100, request.WskaznikWaloryzacjiSubkonta);
